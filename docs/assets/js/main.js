      ...
      if (
        ...
        try {
          c =
            'true' === c ||
            ('false' !== c &&
              ('null' === c ? null : +c + '' === c ? +c : N.test(c) ? n.parseJSON(c) : c));
        } catch (e) {}
        M.set(a, b, c);
      } else c = void 0;
    return c;
  ...
  function Vb(a, b, c) {
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        (j = n.css(a, 'display')),
        'inline' === ('none' === j ? L.get(a, 'olddisplay') || tb(a.nodeName) : j) &&
          'none' === n.css(a, 'float') &&
        ...
        for (f = 0; (g = p[f++]) && !b.isPropagationStopped(); )
          (b.type = f > 1 ? i : o.bindType || q),
            ...
            (m = k && g[k]) &&
              m.apply &&
              n.acceptData(g) &&
              ((b.result = m.apply(g, c)), !1 === b.result && b.preventDefault());
        return (
          (b.type = q),
          e ||
              ...
              (h = f[j]),
                fb.test(h.type || '') &&
                  ...
                  (h.src
                    ...
                    : n.globalEval(
                        h.textContent.replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ''),
                      ));
        }
        return this;
      },
      ...
      attr: function(a, b, c) {
        ...
        if (a && 3 !== f && 8 !== f && 2 !== f)
          return typeof a.getAttribute === U
            ...
            : ((1 === f && n.isXMLDoc(a)) ||
                ((b = b.toLowerCase()),
                (d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Zb : void 0))),
              void 0 === c
              ...
              : function() {
                  if ('string' === c)
                    ...
                    (c === U || 'boolean' === c) &&
                      ...
                      (this.className =
                        this.className || !1 === a ? '' : L.get(this, '__className__') || ''));
                },
          );
    },
    hasClass: function(a) {
    ...
    n.extend({
      ...
      ajax: function(a, b) {
            ...
            j
              ? (k.ifModified &&
                ...
                204 === a || 'HEAD' === k.type
                  ...
                  : 304 === a
                  ? (x = 'notmodified')
                  : ((x = u.loadingState), (r = u.data), (s = u.error), (j = !s)))
        ...
        if (
          ...
          (v.success = v.done),
          (v.error = v.fail),
          (k.url = ((a || k.url || fc) + '').replace(/#.*$/, '').replace(/^\/\//, ec[1] + '//')),
      ...
      return h || 'jsonp' === b.dataTypes[0]
        ? ((e = b.jsonpCallback = n.isFunction(b.jsonpCallback)
          ...
          h
            ...
            : !1 !== b.jsonp && (b.url += (dc.test(b.url) ? '&' : '?') + b.jsonp + '=' + e),
  ...
  (function(t, e) {
    ...
    var u = (e.Events = {
      ...
      c = function(t, e, i, r) {
        ...
        if (l.test(i)) {
          for (var n = i.split(l), a = 0, o = n.length; a < o; a++) t[e].apply(t, [n[a]].concat(r));
          return !1;
        }
        return !0;
      },
    ...
    i.extend(p.prototype, u, {
      ...
      save: function(t, e, r) {
        var s,
          ...
          o = this.attributes;
        if (
          (null == t || 'object' == typeof t ? ((s = t), (r = e)) : ((s = {})[t] = e),
        ...
        return (
          (r.success = function(t) {
            h.attributes = o;
            var e = h.parse(t, r);
            if ((r.wait && (e = i.extend(s || {}, e)), i.isObject(e) && !h.set(e, r))) return !1;
    ...
    i.extend(g.prototype, u, {
      ...
      set: function(t, e) {
        ...
        if (x) {
          for (s = 0, n = this.length; s < n; ++s) _[(o = this.models[s]).cid] || y.push(o);
          y.length && this.remove(y, e);
        }
        if (g.length || (E && E.length))
          if ((d && (l = !0), (this.length += g.length), null != c))
            for (s = 0, n = g.length; s < n; s++) this.models.splice(c + s, 0, g[s]);
          else {
        ...
        if ((l && this.sort({ silent: !0 }), !e.silent)) {
          for (s = 0, n = g.length; s < n; s++) (o = g[s]).trigger('add', o, this, e);
      ...
      _onModelEvent: function(t, e, i, r) {
        (('add' !== t && 'remove' !== t) || i === this) &&
          ...
          e &&
            ...
            (delete this._byId[e.previous(e.idAttribute)], null != e.id && (this._byId[e.id] = e)),
    ...
    (t.version = '0.5.3'),
      ...
      (t.Pipeline.prototype.run = function(t) {
        for (var e = [], n = t.length, i = this._stack.length, o = 0; n > o; o++) {
          for (var r = t[o], s = 0; i > s && void 0 !== (r = this._stack[s](r, o, t)); s++);
          void 0 !== r && e.push(r);
        }
        return e;
      }),
      ...
      (t.Index.prototype.documentVector = function(e) {
        for (
          var n = this.documentStore.get(e), i = n.length, o = new t.Vector(), r = 0;
          i > r;
          r++
        ) {
          var s = n.elements[r],
...
!(function(typedoc) {
  function registerService(constructor, name, priority) {
    void 0 === priority && (priority = 0),
      services.push({ constructor: constructor, name: name, priority: priority, instance: null }),
    ...
    Filter = (function(_super) {
      function Filter(options) {
        ...
        return (
          ...
          (_this.optionOnlyExported = new FilterItemCheckbox('only-exported', !1)),
          _this
        );
      }
      return (
  ...
  var MenuHighlight = (function(_super) {
    ...
    return (
        ...
        -1 != base.indexOf('#') && (base = base.substr(0, base.indexOf('#'))),
          this.$el.find('a').each(function(index, el) {
            ...
            if (-1 != href.indexOf('#') && href.substr(0, base.length) == base) {
              ...
              0 != $anchor.length &&
                _this.anchors.push({ $link: $(el.parentNode), $anchor: $anchor, position: 0 });
            }
          }),
          this.onResize();
      }),
      ...
      (MenuHighlight.prototype.onScroll = function(scrollTop) {
        ...
        this.index != index &&
          (this.index > 0 && this.anchors[this.index].$link.removeClass('focus'),
          (this.index = index),
  ...
  var MenuSticky = (function(_super) {
    function MenuSticky(options) {
      ...
      return (
        ...
        _this.listenTo(typedoc.viewport, 'resize', _this.onResize),
        hasPositionSticky || _this.listenTo(typedoc.viewport, 'scroll', _this.onScroll),
  ...
  !(function(search) {
    ...
    function updateResults() {
      if (loadingState == SearchLoadingState.Ready) {
        $results.empty();
        for (var res = index.search(query), i = 0, c = Math.min(10, res.length); i < c; i++) {
          var row = search.data.rows[res[i].ref],
            name = row.name;
          row.parent && (name = '<span class="parent">' + row.parent + '.</span>' + name),
            $results.append(
              '<li class="' +
                row.classes +
                '"><a href="' +
    ...
    function gotoCurrentResult() {
      ...
      0 == $current.length && ($current = $results.find('li:first-child')),
        $current.length > 0 &&
          ((window.location.href = $current.find('a').prop('href')), $field.blur());
    }
  ...
  var SignatureGroup = (function() {
      ...
      return (
        ...
        (SignatureGroup.prototype.removeClass = function(className) {
          return (
            this.$signature.removeClass(className), this.$description.removeClass(className), this
          );
        }),
        SignatureGroup
      );
        ...
        if (!typedoc.hasPointerMoved && this.active) {
          ...
          if ($path.hasClass('col-menu')) {
            ...
            if ($link.length) {
              ...
              -1 != href.indexOf('#') && (href = href.substr(0, href.indexOf('#'))),
    ...
    typedoc.$document
      ...
      .on('click', function(e) {
        typedoc.preventNextClick &&
          (e.preventDefault(), e.stopImmediatePropagation(), (typedoc.preventNextClick = !1));
      });
})(typedoc || (typedoc = {}));
var typedoc;
!(function(typedoc) {
