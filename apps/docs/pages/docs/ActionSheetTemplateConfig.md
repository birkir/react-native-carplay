...
- [actions](/docs/ActionSheetTemplateConfig.md#actions)
- [id](/docs/ActionSheetTemplateConfig.md#id)
- [leadingNavigationBarButtons](/docs/ActionSheetTemplateConfig.md#leadingnavigationbarbuttons)
- [message](/docs/ActionSheetTemplateConfig.md#message)
- [tabImage](/docs/ActionSheetTemplateConfig.md#tabimage)
- [tabSystemImageName](/docs/ActionSheetTemplateConfig.md#tabsystemimagename)
- [tabSystemItem](/docs/ActionSheetTemplateConfig.md#tabsystemitem)
- [tabTitle](/docs/ActionSheetTemplateConfig.md#tabtitle)
- [title](/docs/ActionSheetTemplateConfig.md#title)
- [trailingNavigationBarButtons](/docs/ActionSheetTemplateConfig.md#trailingnavigationbarbuttons)

### Methods

- [onActionButtonPressed](/docs/ActionSheetTemplateConfig.md#onactionbuttonpressed)
- [onBarButtonPressed](/docs/ActionSheetTemplateConfig.md#onbarbuttonpressed)
- [onDidAppear](/docs/ActionSheetTemplateConfig.md#ondidappear)
- [onDidDisappear](/docs/ActionSheetTemplateConfig.md#ondiddisappear)
- [onWillAppear](/docs/ActionSheetTemplateConfig.md#onwillappear)
- [onWillDisappear](/docs/ActionSheetTemplateConfig.md#onwilldisappear)

## Properties

### actions

• **actions**: [`AlertAction`](/docs/AlertAction.md)[]

#### Defined in

[packages/react-native-carplay/src/templates/ActionSheetTemplate.ts:7](https://github.com/birkir/react-native-carplay/blob/2f9bd9c/packages/react-native-carplay/src/templates/ActionSheetTemplate.ts#L7)
...
[packages/react-native-carplay/src/templates/ActionSheetTemplate.ts:6](https://github.com/birkir/react-native-carplay/blob/2f9bd9c/packages/react-native-carplay/src/templates/ActionSheetTemplate.ts#L6)
...
[packages/react-native-carplay/src/templates/ActionSheetTemplate.ts:5](https://github.com/birkir/react-native-carplay/blob/2f9bd9c/packages/react-native-carplay/src/templates/ActionSheetTemplate.ts#L5)
...
[packages/react-native-carplay/src/templates/ActionSheetTemplate.ts:8](https://github.com/birkir/react-native-carplay/blob/2f9bd9c/packages/react-native-carplay/src/templates/ActionSheetTemplate.ts#L8)
