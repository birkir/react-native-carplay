...
import type { ActionSheetTemplate } from './templates/ActionSheetTemplate';
import type { AlertTemplate } from './templates/AlertTemplate';
import type { ContactTemplate } from './templates/ContactTemplate';
import type { GridTemplate } from './templates/GridTemplate';
import type { InformationTemplate } from './templates/InformationTemplate';
import type { ListTemplate } from './templates/ListTemplate';
import type { MapTemplate } from './templates/MapTemplate';
import type { NowPlayingTemplate } from './templates/NowPlayingTemplate';
import type { PointOfInterestTemplate } from './templates/PointOfInterestTemplate';
import type { SearchTemplate } from './templates/SearchTemplate';
import type { TabBarTemplate } from './templates/TabBarTemplate';
import type { VoiceControlTemplate } from './templates/VoiceControlTemplate';
