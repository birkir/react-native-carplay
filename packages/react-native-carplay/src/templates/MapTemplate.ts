...
import type { MapButton } from '../interfaces/MapButton';
import type { NavigationAlert } from '../interfaces/NavigationAlert';
import type { TextConfiguration } from '../interfaces/TextConfiguration';
import type { TimeRemainingColor } from '../interfaces/TimeRemainingColor';
import type { TravelEstimates } from '../interfaces/TravelEstimates';
import { NavigationSession } from '../navigation/NavigationSession';
import type { Trip } from '../navigation/Trip';
...
export interface MapTemplateConfig extends TemplateConfig {
  ...
  onDidCancelNavigation?(e: undefined): void;
